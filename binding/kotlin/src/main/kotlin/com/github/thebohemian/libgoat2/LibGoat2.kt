package com.github.thebohemian.libgoat2
...
class NativeInstrumentReference : Structure(), Structure.ByReference {
    ...
    @JvmField
    var wavetableLine: Byte = 0
    @JvmField
    var pulsetableLine: Byte = 0
    @JvmField
    var filtertableLine: Byte = 0
    @JvmField
    var speedtableLine: Byte = 0

    @JvmField
    var vibdelay: Byte = 0
    @JvmField
    var gatetimer: Byte = 0
    @JvmField
    var firstwave: Byte = 0

    @JvmField
    var _name = ByteArray(LibGoat2.MAX_STR)
    ...
    override fun getFieldOrder() =
            listOf("ad", "sr", "wavetableLine", "pulsetableLine", "filtertableLine", "speedtableLine", "vibdelay",
                    "gatetimer", "firstwave", "_name")
...
class ParameterTableReference : Structure(), Structure.ByReference {
    ...
    @JvmField
    var bytes = ByteArray(LibGoat2.MAX_TABLE_LEN)
...
class StringReference : Structure(), Structure.ByReference {
    ...
    @JvmField
    var _text = ByteArray(LibGoat2.MAX_STR)
...
class PatternReference : Structure(), Structure.ByReference {
    ...
    @JvmField
    var bytes = ByteArray(LibGoat2.MAX_PATT_ROWS_DATA)
...
class PatternLengthsReference : Structure(), Structure.ByReference {
    ...
    @JvmField
    var lengths = IntArray(LibGoat2.MAX_PATT)
...
class SongOrderReference : Structure(), Structure.ByReference {
    ...
    @JvmField
    var bytes = ByteArray(LibGoat2.MAX_SONGLEN_DATA)
...
class SongLengthsReference : Structure(), Structure.ByReference {
    ...
    @JvmField
    var lengths = IntArray(LibGoat2.MAX_CHN)
